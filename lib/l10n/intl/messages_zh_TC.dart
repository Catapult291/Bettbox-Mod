...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "autoGetNameTip": MessageLookupByLibrary.simpleMessage("留空則自動取得名稱"),
    ...
    "installTime": MessageLookupByLibrary.simpleMessage("安裝時間"),
    ...
    "notificationHighPriorityTip": MessageLookupByLibrary.simpleMessage(
      "高優先級通知在有些自訂系統上可以緩解後台核心保活的問題，如果你的 VPN 服務目前運行正常，這個選項建議繼續保持關閉，確定要開啟嗎",
    ),
    ...
    "viewDetailedIpData": MessageLookupByLibrary.simpleMessage("檢視詳細 IP 資料"),
